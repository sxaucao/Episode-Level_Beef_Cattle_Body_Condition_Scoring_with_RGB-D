...
LOWHIGH_DIR = Path("./05_rgb_depth_comil_lowhigh_animalwise3fold")
LOWHIGH_MEAN_STD_CSV = LOWHIGH_DIR / "05_lowhigh_mean_std.csv"
LOWHIGH_PRED_CSV = LOWHIGH_DIR / "05_lowhigh_predictions.csv"

QC_DIR = Path("./03_quality_controlled_dorsal_angle")
QC_FRAME_CSV = QC_DIR / "03_qc_frame_dorsal_angle.csv"
QC_BAG_CSV = QC_DIR / "03_qc_bag_dorsal_angle.csv"
QC_BAD_REASON_CSV = QC_DIR / "03_bad_reason_counts.csv"

FINAL_DIR = Path("./04_full_ablation_results")
FINAL_MEAN_STD_CSV = FINAL_DIR / "qg_rgb_depth_lowhigh_with_angle/mean_std.csv"
FINAL_FOLD_METRICS_CSV = FINAL_DIR / "qg_rgb_depth_lowhigh_with_angle/fold_metrics.csv"
FINAL_PRED_CSV = FINAL_DIR / "qg_rgb_depth_lowhigh_with_angle/predictions.csv"

OUT_DIR = Path("./06_tables_and_figures_outputs")
