...
ABL_DIR = BASE_PATH / "04_full_ablation_results"
SUMMARY_CSV = ABL_DIR / "04_ablation_summary_table.csv"
EXTREME_CSV = ABL_DIR / "04_ablation_extreme_error_table.csv"

OUT_DIR = BASE_PATH / "07_final_tables_figures"
...
def write_readme():
    ...
    p.write_text(
        "Final tables/figures generated from 04_full_ablation_results.\n"
...
def main():
    print("=" * 100)
    print("Update tables/figures using ablation results as final source")
